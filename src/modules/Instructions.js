export class Instructions {
    ...
    instructionsScreen(width, height, scaleX, scaleY) {
        ...
        this.p5.text("How to Play", width / 2, height / 5.5);
        this.p5.text("Controls", width / 2, height / 2.15);
        this.p5.text("Poker Key", width / 2, height / 1.36);
        ...
        this.p5.text("Enter -> Button Press / Select Letter", width / 2, height / 1.8);
        this.p5.text("Backspace -> Undo Previous Move / Undo Card Select", width / 2, height / 1.68);
        this.p5.text("Spacebar -> Select Omikuji (Fortune) Box", width / 2, height / 1.56);

        this.p5.text("5K -> 5 of a Kind\t\tRF -> Royal Flush\t\tSF -> Straight Flush\t\t4K -> 4 of a Kind\t\tFH -> Full House", width / 2, height / 1.25);
        this.p5.text("ST -> Straight\t\tFL -> Flush\t\t3K -> 3 of a Kind\t\t2P -> 2 Pair\t\t1P -> Pair\t\tH -> Nothing", width / 2, height / 1.18);
        ...
        this.p5.text("BEGIN GAME", width / 2, height * .92 + 5 * scaleY);
